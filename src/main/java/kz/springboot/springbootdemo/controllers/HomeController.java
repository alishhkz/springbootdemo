...
public class HomeController {
    ...
    public String edititem(Model model, @PathVariable(name = "id") Long id) {
        ...
        categories.remove(item.getCategoriesList());
    ...
    public String assignCategory(@RequestParam(name = "item_id")Long itemId,
        ...
        if (cat != null) {
            ...
            if (item != null) {
                List<Categories> categories = item.getCategoriesList();
                if (categories==null) {
    ...
    public String uploadAvatar(@RequestParam(name = "user_ava")MultipartFile file) {
        ...
        @PreAuthorize("isAuthenticated()")
        public @ResponseBody byte[] viewProfilePhoto(@PathVariable(name = "url") String url) throws Exception {
        String pictureURL = viewPath+defaultPicture;
            if (url!=null && !url.equals("null")) {
                pictureURL = viewPath+"jpg";
            }
            InputStream in;
            try {
